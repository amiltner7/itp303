...
<body>
	...
	<div class="container">
			...
			<div class="col-12">
				...
				<table class="table table-responsive">
					...
					<tr>
						...
						<td><?php if($row['award'] == "null") {} else{echo $row['award'];} ?></td>
					</tr>
		...
		<div class="row mt-4 mb-4">
			...
			<!-- Added this edit link, almost identical to class example. It is an anchor tag that references edit_form.php but adds the dvd id to the URL so that we can GET it in edit_form.php and edit the correct dvd -->
			<a href="edit_form.php?id=<?php echo $id; ?>" class="btn btn-warning">
				Edit This DVD</a>
			</div> <!-- .col -->
		</div> <!-- .row -->
	</div> <!-- .container -->
